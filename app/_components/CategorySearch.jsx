...
function CategorySearch() {
  ...
  return (
    <div className='mb-10 items-center px-5 flex flex-col gap-2'>
      ...
      {/* yaha pe code add kiya hai comlicated hai agar problem aaye 
      toh remove kr dio category se niche tak displlay list of cateegory
       ke div se phele curly tak  */}

       
      {categoryList.length>0?categoryList.map((item,index)=>index<1&&(
