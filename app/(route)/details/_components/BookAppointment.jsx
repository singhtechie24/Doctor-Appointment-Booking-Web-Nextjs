    ...
    <DialogHeader>
      ...
      <DialogDescription>
        <div>
            ...
            <Textarea className="mt-3" placeholder="Add any notes here..." onChange={(e)=>setNote(e.target.value)} />
        </div>
      </DialogDescription>
    </DialogHeader>
    <DialogFooter className="sm:justify-end">
    {/* <DialogFooter className="flex flex-wrap items-center justify-between p-4 sm:justify-end"> */}
    {/* <Textarea
